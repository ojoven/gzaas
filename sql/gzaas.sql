...
INSERT INTO `fonts` (`idF`, `inUse`, `featured`, `font`, `idHashtag`, `fontFamily`, `fontFace`, `stylesheet`, `cssScreenshot`, `size`, `fontServer`, `designer`, `urlDesigner1`, `urlDesigner2`, `description`, `exclusive`) VALUES
...
(28, 1, 0, 'slackey', 28, '''Slackey''', 1, 'Slackey:regular', '@font-face {\n  font-family: ''Slackey'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Slackey''), url(http://fonts.gstatic.com/s/slackey/v6/bJZDrYrGx8atJRHR9DVdqg.ttf) format(''truetype'');\n}\n', 1.50, 2, 'Sideshow', 'http://code.google.com/webfonts/designer?designer=Sideshow', 'http://squidart.com/', 'Slackey', 0),
(29, 1, 1, 'allan', 29, '''Allan''', 1, 'Allan:bold', '@font-face {\n  font-family: ''Allan'';\n  font-style: normal;\n  font-weight: 700;\n  src: local(''Allan Bold''), local(''Allan-Bold''), url(http://fonts.gstatic.com/s/allan/v7/QNNVW1nta25A1TfGw7wquPesZW2xOQ-xsNqO47m55DA.ttf) format(''truetype'');\n}', 1.00, 2, 'Anton Koovit', 'http://code.google.com/webfonts/designer?designer=Anton+Koovit', 'http://anton.korkork.com/', 'Allan', 0),
...
(31, 1, 0, 'anonymouspro', 31, '''Anonymous Pro''', 1, 'Anonymous+Pro:regular,italic,bold,bolditalic', '@font-face {\n  font-family: ''Anonymous Pro'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Anonymous Pro''), local(''AnonymousPro''), url(http://fonts.gstatic.com/s/anonymouspro/v8/Zhfjj_gat3waL4JSju74Eyepy_bK1QysdtOeR9F4Ffs.ttf) format(''truetype'');\n}\n@font-face {\n  font-family: ''Anonymous Pro'';\n  font-style: normal;\n  font-weight: 700;\n  src: local(''Anonymous Pro Bold''), local(''AnonymousPro-Bold''), url(http://fonts.gstatic.com/s/anonymouspro/v8/WDf5lZYgdmmKhO8E1AQud_PUlNJBs1LjT_hi6_KOI-I.ttf) format(''truetype'');\n}\n@font-face {\n  font-family: ''Anonymous Pro'';\n  font-style: italic;\n  font-weight: 400;\n  src: local(''Anonymous Pro Italic''), local(''AnonymousPro-Italic''), url(http://fonts.gstatic.com/s/anonymouspro/v8/q0u6LFHwttnT_69euiDbWHYERyxqu4bunGuIRUtIkRI.ttf) format(''truetype'');\n}\n@font-face {\n  font-family: ''Anonymous Pro'';\n  font-style: italic;\n  font-weight: 700;\n  src: local(''Anonymous Pro Bold Italic''), local(''AnonymousPro-BoldItalic''), url(http://fonts.gstatic.com/s/anonymouspro/v8/_fVr_XGln-cetWSUc-JpfG5LgoF-04rdOuVmAyCISpg.ttf) format(''truetype'');\n}', 1.00, 2, 'Mark Simonson', 'http://code.google.com/webfonts/designer?designer=Mark+Simonson', 'http://www.ms-studio.com', 'Anonymous Pro', 0),
...
(33, 1, 0, 'bentham', 33, '''Bentham''', 1, 'Bentham:regular', '@font-face {\n  font-family: ''Bentham'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Bentham''), local(''Bentham-Regular''), url(http://fonts.gstatic.com/s/bentham/v6/bNMs0W99XSO_uhoBJof6Tg.ttf) format(''truetype'');\n}', 1.00, 2, 'Ben Weiner', 'http://code.google.com/webfonts/designer?designer=Ben+Weiner', 'http://www.readingtype.org.uk', 'Bentham', 0),
...
(35, 1, 0, 'cabin', 35, '''Cabin''', 1, 'Cabin:bold', '@font-face {\n  font-family: ''Cabin'';\n  font-style: normal;\n  font-weight: 700;\n  src: local(''Cabin Bold''), local(''Cabin-Bold''), url(http://fonts.gstatic.com/s/cabin/v7/nHiQo1BypvYzt95zlPq1TvesZW2xOQ-xsNqO47m55DA.ttf) format(''truetype'');\n}', 1.00, 2, 'Pablo Impallari', 'http://code.google.com/webfonts/designer?designer=Pablo+Impallari', 'http://www.impallari.com/', 'Cabin', 0),
(36, 1, 1, 'calligraffitti', 36, '''Calligraffitti''', 1, 'Calligraffitti:regular', '@font-face {\n  font-family: ''Calligraffitti'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Calligraffitti''), local(''Calligraffitti-Regular''), url(http://fonts.gstatic.com/s/calligraffitti/v7/vLVN2Y-z65rVu1R7lWdvyF9q9cSakIY5dTu4rft1WBw.ttf) format(''truetype'');\n}', 1.00, 2, 'Open Window', 'http://code.google.com/webfonts/designer?designer=Open+Window', 'http://new.myfonts.com/foundry/Open_Window/', 'Calligraffitti', 0),
(37, 1, 1, 'chewy', 37, '''Chewy''', 1, 'Chewy:regular', '@font-face {\n  font-family: ''Chewy'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Chewy''), url(http://fonts.gstatic.com/s/chewy/v7/9pHJyFOcO5WaMZJw9XnkAw.ttf) format(''truetype'');\n}\n', 1.00, 2, 'Sideshow', 'http://code.google.com/webfonts/designer?designer=Sideshow', 'http://squidart.com/', 'Chewy', 0),
...
(39, 1, 0, 'comingsoon', 39, '''Coming Soon''', 1, 'Coming+Soon:regular', '@font-face {\n  font-family: ''Coming Soon'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Coming Soon''), local(''ComingSoon''), url(http://fonts.gstatic.com/s/comingsoon/v6/myblyOycMnPMGjfPG-DzP50EAVxt0G0biEntp43Qt6E.ttf) format(''truetype'');\n}', 1.00, 2, 'Open Window', 'http://code.google.com/webfonts/designer?designer=Open+Window', 'http://new.myfonts.com/foundry/Open_Window/', 'Coming Soon', 0),
...
(42, 1, 0, 'kranky', 42, '''Kranky''', 1, 'Kranky:regular', '@font-face {\n  font-family: ''Kranky'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Kranky''), url(http://fonts.gstatic.com/s/kranky/v6/9MhcqozOOK22yTdfTb9Abg.ttf) format(''truetype'');\n}', 1.00, 2, 'Sideshow', 'http://code.google.com/webfonts/designer?designer=Sideshow', 'http://squidart.com/', 'Kranky', 0),
(43, 1, 0, 'sniglet', 43, '''Sniglet''', 1, 'Sniglet:800', '@font-face {\n  font-family: ''Sniglet'';\n  font-style: normal;\n  font-weight: 800;\n  src: local(''Sniglet ExtraBold''), local(''Sniglet-ExtraBold''), url(http://fonts.gstatic.com/s/sniglet/v7/1ZHjsYpklbehZSiZpN0bvi3USBnSvpkopQaUR-2r7iU.ttf) format(''truetype'');\n}', 1.00, 2, 'Haley Fiege', 'http://www.google.com/webfonts/designer?designer=Haley+Fiege', 'http://www.kingdomofawesome.com', 'Sniglet', 0),
(44, 1, 0, 'reeniebeanie', 44, '''Reenie Beanie''', 1, 'Reenie+Beanie:regular', '@font-face {\n  font-family: ''Reenie Beanie'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Reenie Beanie''), local(''ReenieBeanie''), url(http://fonts.gstatic.com/s/reeniebeanie/v6/ljpKc6CdXusL1cnGUSamXybsRidxnYrfzLNRqJkHfFo.ttf) format(''truetype'');\n}', 1.00, 2, 'James Grieshaber', 'http://www.google.com/webfonts/designer?designer=James+Grieshaber', 'http://en.wikipedia.org/wiki/James_Grieshaber', 'Reenie Beanie', 0),
...
(46, 1, 0, 'permanentmarker', 46, '''Permanent Marker''', 1, 'Permanent+Marker:regular', '@font-face {\n  font-family: ''Permanent Marker'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Permanent Marker''), local(''PermanentMarker''), url(http://fonts.gstatic.com/s/permanentmarker/v5/9vYsg5VgPHKK8SXYbf3sMrg27BfaRSB61e9iDGqjWqk.ttf) format(''truetype'');\n}', 1.00, 2, 'Font Diner', 'http://www.google.com/webfonts/designer?designer=Font+Diner', 'http://www.fontdiner.com', 'Permanent Marker', 0),
(47, 1, 0, 'mountainsofchristmas', 47, '''Mountains of Christmas''', 1, 'Mountains+of+Christmas:regular', '@font-face {\n  font-family: ''Mountains of Christmas'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Mountains of Christmas''), local(''MountainsofChristmas-Regular''), url(http://fonts.gstatic.com/s/mountainsofchristmas/v8/dVGBFPwd6G44IWDbQtPew1bt-oIll-RyBOVQqGBP3Ww.ttf) format(''truetype'');\n}\n', 1.00, 2, 'Tart Workshop', 'http://www.google.com/webfonts/designer?designer=Tart+Workshop', 'http://www.tartworkshop.com', 'Mountains of Christmas', 0),
(48, 1, 1, 'luckiestguy', 48, '''Luckiest Guy''', 1, 'Luckiest+Guy:regular', '@font-face {\n  font-family: ''Luckiest Guy'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Luckiest Guy''), local(''LuckiestGuy-Regular''), url(http://fonts.gstatic.com/s/luckiestguy/v6/5718gH8nDy3hFVihOpkY5InF5uFdDttMLvmWuJdhhgs.ttf) format(''truetype'');\n}', 1.00, 2, 'Astigmatic', 'http://www.google.com/webfonts/designer?designer=Astigmatic', 'http://www.astigmatic.com', 'Luckiest Guy', 0),
...
(66, 1, 0, 'damion', 66, '''Damion''', 1, 'Damion:regular', '@font-face {\n  font-family: ''Damion'';\n  font-style: normal;\n  font-weight: 400;\n  src: local(''Damion''), url(http://fonts.gstatic.com/s/damion/v6/dGdglhCE3HXjR5yo_XK_2g.ttf) format(''truetype'');\n}', 1.00, 2, 'Vernon Adams', 'http://www.google.com/webfonts/designer?designer=Vernon+Adams', 'http://www.newtypography.co.uk/', 'Damion', 0);
