...
class My_Routers
{
	public function __construct()
	{
		...
		$routeMobileIndex = new Zend_Controller_Router_Route_Regex(
    				'm/index',
    				array(
    					'module' => 'mobile',
        				'controller' => 'index',
		...
		$router->addRoute('mobileindex', $routeMobileIndex);



		//gzaas - Preview
		$routeMobilePreview = new Zend_Controller_Router_Route_Regex(
    				'm/preview',
    				array(
    					'module' => 'mobile',
        				'controller' => 'preview',
		...
		$router->addRoute('mobilepreview', $routeMobilePreview);


		//gzaas - Mobile GetFeaturedStyles (AJAX)
		$routeGetFeaturedStyles = new Zend_Controller_Router_Route_Static('m/getfeaturedstyles',
				  array('module' => 'mobile','controller' => 'preview', 'action' => 'getfeaturedstyles')
				  );
		$router->addRoute('getfeaturedstyles', $routeGetFeaturedStyles);
